...
namespace Test.input5.json._5_render_as_ASCII_context_menu
{
    class Style
    {
        void Build(Builder builder)
        {
            builder.Add(
                new Sentence(new Subject(new NotEquals(new Path(new Id("items"), new Item()), new Null())),
                    new Predicate(), new Sentence(new Subject(new ShortOr(new Path(new Start(), new Id("label")),
                                                                          new Path(new Start(), new Id("id")))),
